...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visit.scheduled_date'
        db.add_column('patients_visit', 'scheduled_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visit.scheduled_date'
        db.delete_column('patients_visit', 'scheduled_date')
