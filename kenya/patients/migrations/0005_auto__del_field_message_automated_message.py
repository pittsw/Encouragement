...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.automated_message'
        db.delete_column('patients_message', 'automated_message_id')


    def backwards(self, orm):
        # Adding field 'Message.automated_message'
        db.add_column('patients_message', 'automated_message',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='automated_message', null=True, to=orm['backend.AutomatedMessage'], blank=True),
                      keep_default=False)
