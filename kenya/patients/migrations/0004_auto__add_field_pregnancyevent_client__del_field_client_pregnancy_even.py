...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PregnancyEvent.client'
        db.add_column('patients_pregnancyevent', 'client',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['patients.Client'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Client.pregnancy_event'
        db.delete_column('patients_client', 'pregnancy_event_id')


    def backwards(self, orm):
        # Deleting field 'PregnancyEvent.client'
        db.delete_column('patients_pregnancyevent', 'client_id')

        # Adding field 'Client.pregnancy_event'
        db.add_column('patients_client', 'pregnancy_event',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['patients.PregnancyEvent'], unique=True, null=True, blank=True),
                      keep_default=False)
