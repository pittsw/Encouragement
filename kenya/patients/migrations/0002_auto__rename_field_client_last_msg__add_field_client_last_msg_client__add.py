...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Client.last_msg'
        db.rename_column('patients_client', 'last_msg','last_msg_client')

        # Adding field 'Client.last_msg_system'
        db.add_column('patients_client', 'last_msg_system',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Renaming field 'Client.last_msg_client'
        db.rename_column('patients_client', 'last_msg_client','last_msg')

        # Deleting field 'Client.last_msg_system'
        db.delete_column('patients_client', 'last_msg_system')
